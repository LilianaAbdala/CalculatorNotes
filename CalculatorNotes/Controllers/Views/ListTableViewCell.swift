...
class ListTableViewCell: BaseTableCell {
    ...
    lazy var container: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor.init(rgb: 0x8ecae6)
    ...
    override func addConstraints() {
        ...
        studentTextField.anchor(top: nil, leading: nil, bottom: nil, trailing: nil, padding: .init(top: 20, left: 20, bottom: 0, right: 0), size: .init(width: 600, height: 50))
